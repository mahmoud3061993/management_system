            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="handleAddEmployee.php" method="POST" >
                        ...
                        ?>
                        <?php
                            if ( isset($_GET['message']) && $_GET['message'] == 30)
                            {
                                echo 
                        ...
                        <?php
                            ...
                            if ( isset($_GET['message']) && $_GET['message'] == 10 )
                            {
                                ...
                                password should be between 5 and 10 chars. !!
                                </div>";
                            }
                        ...
                        <?php
                            ...
                            if ( isset($_GET['message']) && $_GET['message'] == 8)
                            {
                                echo 
                        ...
                        <div class="input-group">
                            ...
                            if ( isset($_GET['message']) && $_GET['message'] == 40)
                            {
                                echo 
